...
if ((y == 2024 && m == 4 && dd == 4) || (y == 2025 && m == 4 && dd == 4) || (y == 2026 && m == 4 && dd == 5) || (y == 2027 && m == 4 && dd == 5) || (y == 2028 && m == 4 && dd == 4) || (y == 2029 && m == 4 && dd == 4) || (y == 2030 && m == 4 && dd == 5)) {//清明节
  if (sessionStorage.getItem("isPopupWindow") != "1") {
    Swal.fire("清明时节雨纷纷,一束鲜花祭故人💐");
    sessionStorage.setItem("isPopupWindow", "1");
  }
}
if ((y == 2023 && m == 12 && dd == 22) || (y == 2024 && m == 12 && dd == 21) || (y == 2025 && m == 12 && dd == 21) || (y == 2026 && m == 12 && dd == 22) || (y == 2027 && m == 12 && dd == 22) || (y == 2028 && m == 12 && dd == 21) || (y == 2029 && m == 12 && dd == 21) || (y == 2030 && m == 12 && dd == 22)) {//冬至
  if (sessionStorage.getItem("isPopupWindow") != "1") {
    Swal.fire("冬至快乐\n快吃上一碗热热的汤圆和饺子吧🧆");
    sessionStorage.setItem("isPopupWindow", "1");
  }
...
<br>
<center><p><button class="btn_bg1" onclick="reset()" style="background:linear-gradient(to right, #fc354c, #0abfbc);display:block;width:40%;padding:15px 0;border-radius:30px;color:white;font-size:1.1em;"><i class="fa-solid fa-arrows-rotate"></i>&nbsp;恢复默认设置</button></p></center>
...
<details class="folding-tag" cyan><summary> 查看海贼王背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/images/One_Piece/1.jpg)" class="imgbox" onclick="changeBg('url(/assets/images/One_Piece/1.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/images/One_Piece/2.jpg)" class="imgbox" onclick="changeBg('url(/assets/images/One_Piece/2.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/images/One_Piece/3.jpg)" class="imgbox" onclick="changeBg('url(/assets/images/One_Piece/3.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/images/One_Piece/4.jpg)" class="imgbox" onclick="changeBg('url(/assets/images/One_Piece/4.jpg)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/images/cartoon/1.webp)" class="imgbox" onclick="changeBg('url(/assets/images/cartoon/1.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/images/cartoon/2.webp)" class="imgbox" onclick="changeBg('url(/assets/images/cartoon/2.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/images/cartoon/3.webp)" class="imgbox" onclick="changeBg('url(/assets/images/cartoon/3.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/images/cartoon/4.webp)" class="imgbox" onclick="changeBg('url(/assets/images/cartoon/4.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看适配手机的背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/phone/1.webp)" class="pimgbox" onclick="changeBg('url(/assets/phone/1.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/phone/2.jpeg)" class="pimgbox" onclick="changeBg('url(/assets/phone/2.jpeg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/phone/3.webp)" class="pimgbox" onclick="changeBg('url(/assets/phone/3.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/phone/4.webp)" class="pimgbox" onclick="changeBg('url(/assets/phone/4.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/phone/5.webp)" class="pimgbox" onclick="changeBg('url(/assets/phone/5.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/phone/6.webp)" class="pimgbox" onclick="changeBg('url(/assets/phone/6.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/phone/7.webp)" class="pimgbox" onclick="changeBg('url(/assets/phone/7.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/phone/8.webp)" class="pimgbox" onclick="changeBg('url(/assets/phone/8.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 设置自定义背景 </summary>
              <div class='content'>
              <p>  <center>    <input type="text" id="pic-link" size="70%" maxlength="1000" placeholder="请输入有效的图片链接，如 https://fastly.jsdelivr.net/gh/1405720461/Arknights-img@main/Arknights2/222.webp">  </center></p><p>  <center>    <button type="button" class="custom_bg" onclick="getPicture()" style="background:var(--theme-color);width:35%;padding: 5px 0px 7px 0px;border-radius:30px;color:white;line-height:2;">🌈切换背景🌈</button>  </center></p>
              </div>
            </details>
